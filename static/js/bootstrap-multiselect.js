...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        templates: {
            ...
            filter: '<div class="input-group"><span class="input-group-addon" style="border-radius: 0;border-left: 0px;border-top: 0px;"><i class="fa fa-search"></i></span><input class="form-control multiselect-search" style="border-top: 0px;border-left: 0px;" type="text"></div>',
