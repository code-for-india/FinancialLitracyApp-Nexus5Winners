     ...
     */ (function(window, undefined) {
        ...
        setDocument = Sizzle.setDocument = function(node) {
            ...
            support.getByName = assert(function(div) {
                ...
                doc.getElementsByName(expando + 0)
                    .length;
            ...
            filter: {
                ...
                "ATTR": function(name, operator, check) {
                    return function(elem) {
                        ...
                        return operator === "=" ? result === check : operator === "!=" ? result !== check : operator === "^=" ? check && result.indexOf(check) === 0 : operator === "*=" ? check && result.indexOf(check) > -1 : operator === "$=" ? check && result.slice(-check.length) === check : operator === "~=" ? (" " + result + " ")
            ...
            for (; i < len; i++) {
                if ((matcher = Expr.relative[tokens[i].type])) {
                    ...
                    if (matcher[expando]) {
                        ...
                        i > 1 && toSelector(tokens.slice(0, i - 1))
                            .replace(rtrim, "$1"),
                        matcher,
            ...
            if (!seed) {
                ...
                if (match.length === 1) {
                    ...
                    if (tokens.length > 2 && (token = tokens[0])
                        .type === "ID" && context.nodeType === 9 && !documentIsXML && Expr.relative[tokens[1].type]) {
